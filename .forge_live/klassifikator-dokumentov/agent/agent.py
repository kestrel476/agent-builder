#!/usr/bin/env python3
"""Точка входа для сгенерированного агента: Классификатор документов.
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="Классификатор документов (сгенерированный юридический агент)")
