#!/usr/bin/env python3
"""Точка входа для сгенерированного агента: Ревью пакета сделки.
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="Ревью пакета сделки (сгенерированный юридический агент)")
