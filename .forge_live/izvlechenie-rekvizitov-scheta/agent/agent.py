#!/usr/bin/env python3
"""Точка входа для сгенерированного агента: Извлечение реквизитов счёта.
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="Извлечение реквизитов счёта (сгенерированный юридический агент)")
