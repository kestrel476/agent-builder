#!/usr/bin/env python3
"""Точка входа для сгенерированного агента: Экспертиза банковской гарантии.
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="Экспертиза банковской гарантии (сгенерированный юридический агент)")
